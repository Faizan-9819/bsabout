...
const ProofAndScale: FC = () => {
  return (
    <section className="w-full min-h-screen bg-gradient-to-r from-[#BF584F] to-[#F6736A] flex items-center py-16 lg:py-0">
      <div className="fix flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <div className="w-full lg:w-1/2 text-white space-y-6 md:space-y-7">
          <div>
            ...
            <div className="lg:w-[73%] w-full h-[1px] bg-white" />
          </div>
          ...
          <div className="space-y-6 text-sm md:text-base text-white leading-relaxed max-w-3xl">
            ...
            <p>
              ...
              ownership, and a <br className="hidden lg:inline-block" />
              growth mindset. Whether your strength is in development,
              operations, <br className="hidden lg:inline-block" />
              strategy, leasing, or execution, we believe great infrastructure
