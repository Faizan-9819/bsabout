...
export default function CTASection() {
  ...
  return (
    <section className="relative w-full min-h-[320px] lg:min-h-[310px] bg-neutral-800 text-white overflow-hidden font-sans flex items-center py-12 md:py-0">
      ...
      <div className="relative z-10 fix flex lg:flex-row flex-col justify-between gap-8 md:gap-6 lg:gap-12 items-start lg:items-center">
        {/* Left Column: Heading */}
        <div className="md:col-span-5 lg:col-span-4">
          <h2 className="text-[30px] lg:text-[37.5px] font-semibold tracking-[-1.12px] leading-[109%] text-white">
            Let's develop a facility <br /> built to operate.
          </h2>
        </div>
        ...
        <div className="md:col-span-4 lg:col-span-5">
          <p className="text-[13px] lg:text-start lg:text-[16.5px] font-[300] leading-[160%] ">
            ...
            <br className="hidden lg:flex" /> logistics hub, or a fulfilment
            facility, BuildINFRA turns
            <br className="hidden lg:flex" /> the infrastructure decision into
            an operational outcome
            <br className="hidden lg:flex" /> — faster, compliant, and
