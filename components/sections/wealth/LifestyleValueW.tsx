      ...
      <div className="fix">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-9 lg:mb-16">
          ...
          >
            ...
            >
              From opportunity to <br className="hidden lg:inline-block" />
          ...
          <div className="w-full lg:w-[40%] lg:sticky lg:top-[80px] h-fit">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden bg-black/20">
                ...
                {/* Bottom dark overlay */}
                <div className="absolute inset-x-0 bottom-0 h-[45%] bg-gradient-to-t from-black/75 via-black/35 to-transparent pointer-events-none z-10" />
