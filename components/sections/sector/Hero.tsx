...
const Hero = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url('/sector/sector.webp')" }}
      // Changed "items-center" to "items-end md:items-center" and added bottom padding on mobile "pb-12 md:pb-0"
      className="relative w-full inset-0 bg-cover bg-center bg-no-repeat min-h-screen md:h-[100vh] flex items-end md:items-center pb-12 md:pb-0 overflow-hidden"
    >
