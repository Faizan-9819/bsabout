        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-6 lg:gap-12 items-center w-full">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            <h2 className="text-[30px] lg:text-[37.5px] font-semibold tracking-[-1.12px] leading-[109%] text-white">
              Your land may be worth more than its current use{" "}
            </h2>
          </div>

          {/* Middle Column: Explanatory Subtext */}
          <div className="md:col-span-4 lg:col-span-5">
            <p className="text-[13px] lg:max-w-[70%] text-start lg:text-[16.5px] lg:ps-8 font-[300] leading-[160%] text-neutral-200">
              Whether you hold a single strategic parcel or an institutional
              land bank, BuildVALUE can assess its potential and chart a
              development path that creates long-term value — with ownership
              remaining yours throughout.
            </p>
          </div>
