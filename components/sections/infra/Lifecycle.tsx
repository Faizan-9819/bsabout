                        ...
                        <div className="w-full pt-4 pb-6 flex flex-col gap-6">
                          ...
                          >
                            ...
                            {stage.strategicValue && (
                              <div className="text-xs p-4 rounded-xl bg-white/5 border border-white/5 flex gap-2 items-start">
                                <span className="font-semibold tracking-wider text-[11px] text-[#fff] uppercase shrink-0">
                                  Value:
                                </span>
