...
// import { useRef } from "react";
// // Import Framer Motion layout orchestration dependencies
...
//   // =========================================================================
//   const ghostScrollRef = useRef(null); // Structural height container tracking the page scroll track
//   const containerRef = useRef(null); // Bounding container providing clipping view window width
//   const sliderRef = useRef(null); // Structural horizontal element row track

//   // =========================================================================
//   // FRAMER MOTION INTERPOLATION ENGINE
//   // =========================================================================
//   // Monitor the scroll progress specifically across our target wrapper bounding layout box
//   const { scrollYProgress } = useScroll({
//     target: ghostScrollRef,
//     offset: ["start start", "end end"], // Pin sets off when section top is at viewport top, ends at section bottom
//   });

//   // Pure function calculation determining the total overflowing hidden row pixels dynamically
//   const getScrollAmount = () => {
...
//   // Bind the vertical scroll fraction range [0, 1] linearly to horizontal X translation
...
//   // Bind the same scroll fraction to scale the visual progress indicator cleanly
...
//   // =========================================================================
//   return (
//     /* ghostScrollRef acts as the pin spacer. A height of h-[200vh] provides
//        one viewport height of scrolling room to fully slide across the metrics. */
//     <div ref={ghostScrollRef} className="relative w-full h-[200vh]">
//       {/* Sticky container pins the visual layout at the top of the viewport
//           for exactly 80vh while the user scrolls down the 200vh height track. */}
//       <div className="sticky top-0 h-[80vh] w-full overflow-hidden flex flex-col justify-center pb-[64px]">
//         <section
...
//               className="overflow-hidden w-full px-6 md:px-[120px]"
//             >
//               {/* Converted to a motion element to listen directly to the smooth xTransform variable */}
//               <motion.div
//                 ref={sliderRef}
//                 style={{ x: xTransform }}
//                 className="flex items-stretch gap-0 will-change-transform"
...
//               </span>
//               <div className="w-[46px] h-[1px] bg-white/40 relative overflow-hidden">
//                 {/* Converted to a motion element using the automated loader variable */}
//                 <motion.div
