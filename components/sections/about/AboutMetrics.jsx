          ...
          <div className="relative z-10 w-full">
            ...
            <div ref={containerRef} className="overflow-hidden w-full">
              ...
              <motion.div
                ref={sliderRef}
                style={{ x: xTransform }}
                className="flex items-stretch gap-0 will-change-transform px-6 md:pl-[25px] "
              >
                {stats.map((stat, i) => (
                  <div
                    key={`${stat.label}-${i}`}
                    className={`flex flex-col gap-3 pt-3 pb-1 w-[280px] md:w-[340px] last:pr-0  shrink-0 ${
                      i !== 0 ? "border-l border-white/20 pl-12 pr-12" : ""
                    }`}
                  >
                    <div className="h-[54px] flex items-end">
                      <img
