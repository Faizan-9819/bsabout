...
//                     </div>
//                     <div>
//                       <h3 className="mb-[14px] text-[18px] font-bold leading-[1.2] text-[#003b9d] lg:text-[19px] tracking-[-0.3px]">
//                         {project.title}
//                       </h3>
...
//               transition={{
//                 ease: "linear",
//                 // 💡 SPEED ADJUSTMENT: Reduced desktop time duration from 25s to 14s for faster pacing
//                 duration: 14,
//                 repeat: Infinity,
//               }}
//               style={{
//                 // 💡 GPU LAYER TRICK: Prevents repaint frame lag on slow mobile browsers
//                 willChange: "transform",
//               }}
//             >
//               {/* 💡 ARRAY PERFORMANCE DEBT: Swapped [...logos, ...logos, ...logos] for a clean two-times mirror loop */}
  ...
  return (
    <section className="relative bg-[url('/home/Spotlight/bgspot.webp')] bg-cover bg-center overflow-hidden py-[50px] lg:py-[100px] font-sans select-none">
      ...
      <div className="relative z-10 fix">
        ...
        {/* Desktop Slider Container Frame */}
        <div className="relative w-full h-auto sm:h-[420px] lg:h-[460px] hidden sm:block overflow-hidden">
          <motion.div
          ...
          >
            {initialProjectsData.map((project) => (
              <div key={project.id} className="h-full w-full shrink-0 px-3">
                {/* Card Main Block Body matching screenshot layout */}
                <div className="group flex h-full bg-white border border-black/[0.04] rounded-xl overflow-hidden">
                  {/* Left Side Graphic Image Box */}
                  <div className="relative w-[45%] h-auto m-[32px] rounded-lg bg-[#e4e4e4] overflow-hidden shrink-0">
                    {project.image1 ? (
                      <img
                        src={project.image1}
                        alt={project.title}
                  ...
                  {/* Right Side Text Content Box */}
                  <div className="flex flex-col justify-center gap-y-4 lg:gap-y-6 py-6 pr-6 lg:py-[35px] flex-1 lg:pr-16 bg-white">
                    <div className="flex items-center gap-2 text-[14px] font-bold tracking-[1.5px] text-black/40 uppercase">
                      <img
                        src="/home/Spotlight/spotlight1.svg"
                        alt=""
        ...
        {/* DYNAMIC MOBILE CAROUSEL SLIDER BLOCK (UNTOUCHED) */}
        <div className="block sm:hidden overflow-hidden w-full">
          <motion.div
            animate={{ x: `calc(-${activeCard} * (100% + 20px))` }}
            transition={{ type: "spring", stiffness: 280, damping: 30 }}
          ...
          >
            {initialProjectsData.map((project) => (
              <div
                key={`mobile-project-${project.id}`}
                className="w-full min-w-full flex-shrink-0 bg-white border border-black/[0.04] rounded-sm  flex flex-col overflow-hidden"
              >
                <div className="relative aspect-[16/10] bg-[#e4e4e4] w-full">
                  <img
                    src={project.image1}
        ...
        {/* Corporate Associates Bottom Infinite Ticker Box */}
        <div className="w-full border border-black/[0.04] bg-white py-8 px-6 rounded-sm overflow-hidden relative">
          <div
            className="absolute left-0 top-0 bottom-0 z-10 pointer-events-none"
            style={{
              width: "127px",
