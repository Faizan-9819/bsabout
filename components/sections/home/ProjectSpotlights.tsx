...
// const logos = [
//   { name: "APM Terminals", src: "/home/Spotlight/apm.svg" }, // Aap apna actual image path yahan dalien
...
//         {/* Title */}
//         <h2 className="mb-12 text-[28px] font-bold tracking-[-0.8px] text-[#e27244] sm:text-[36px] lg:text-[44px] leading-[1.15]">
//           Selected projects across industrial & logistics development
//         </h2>

//         {/* Fixed Height Deck Canvas Frame Container */}
//         <div className="relative w-full h-[520px] sm:h-[420px] lg:h-[460px] pr-12 sm:pr-24">
//           {initialProjectsData.map((project, i) => {
//             // ── INFINITE LOOP INDEX CALCULATIONS ──
...
//             // ── DYNAMIC X (HORIZONTAL OFFSETS) & SCALE CALCULATIONS ──
//             let tx: number | string;
//             let sc = 1;
...
//               sc = 1;
//             } else if (effectiveRel === 1) {
//               tx = "20%"; // Moves it right by half its width
//               sc = 0.85;
//             } else if (effectiveRel === 2) {
//               tx = "38%"; // Moves it right by 90% of its width
//               sc = 0.7;
//             } else if (effectiveRel === 3) {
//               tx = "0%"; // Moves it left by 30% of its width
//               sc = 0.8;
//             }

//             // Vertical offset for stack layering depth
//             const ty = effectiveRel * 6;

//             // Opacity layering management
//             const op = 1;
//             // const op = rel === 0 ? 1 : rel === 1 ? 0.8 : rel === 2 ? 0.4 : 0;
...
//                 </div>
//               </motion.div>
//             ); // <-- Yahin par missing syntax fix kiya gaya hai
//           })}

//           {/* Simple Mobile Fallback View Structure */}
//           <div className="block sm:hidden w-full bg-white p-6 border rounded-sm shadow-sm">
//             <div className="text-[10px] font-bold text-black/40 tracking-wider mb-2">
//               {initialProjectsData[activeCard].tag}
//             </div>
//             <h3 className="text-[18px] font-bold text-[#003b9d] mb-3">
//               {initialProjectsData[activeCard].title}
//             </h3>
//             <p className="text-[13px] text-[#54514c] leading-relaxed mb-6">
//               {initialProjectsData[activeCard].desc}
//             </p>
//             <a
//               href="#"
//               className="text-[12px] font-bold text-[#003b9d] inline-flex items-center gap-1"
//             >
...
//         {/* Corporate Associates Bottom Grid Row */}
...
//             {/* Infinite Horizontal Animation Container Layer */}
//             <motion.div
...
//               }}
//             >
//               {/* Loop Track Phase - Double Render Strategy for Smooth Continuous Stitch */}
...
//                     />
//                   ) : (
//                     // Fallback placeholder agar image crash ya absent ho
