      ...
      <div className="fix">
        ...
        >
          ...
          <a
            ...
            className="w-full justify-between md:w-auto flex-shrink-0 flex items-center gap-3 bg-[#e27244] text-white font-semibold text-[15.5px] pl-[26px] pr-4 py-[15px] hover:bg-[#c9603a] transition-colors"
          >
            View All
            <span className="w-[30px] h-[30px] bg-white/16 flex items-center justify-center flex-shrink-0">
              <ArrowUpRight size={16} strokeWidth={2} />
