            ...
            return (
              ...
              >
                <button
                  type="button"
                  onClick={() => handleRowClick(i)}
                  className="w-full text-left cursor-pointer py-6 lg:py-8 focus:outline-none relative pr-0 md:pr-[88px]"
                >
                  <div className="flex flex-col md:flex-row justify-between gap-6 lg:gap-8 items-start">
                    {/* Left Column */}
                    <div className="flex items-start gap-6 lg:gap-[89px] shrink-0">
                      ...
                      <motion.div
                        ...
                        transition={{ duration: 0.3, ease: "easeInOut" }}
                        className={`font-normal shrink-0 transition-[font-size] duration-300 ${isActive ? "md:text-[48px] text-[28px]" : "md:text-[40px] text-[24px]"}`}
                        style={{
                          letterSpacing: "-0.92px",
                          minWidth: "clamp(180px, 20vw, 288px)",
                          lineHeight: 1.1,
